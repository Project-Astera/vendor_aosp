...
PRODUCT_COPY_FILES += \
    vendor/aosp/prebuilt/common/etc/init/init.astera-updater.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.pixelexperience-updater.rc
