...
bacon: $(INTERNAL_OTA_PACKAGE_TARGET)
	...
	@echo -e ${CL_CYN}"            _____ _______ ______ _____            "${CL_CYN}
	@echo -e ${CL_CYN}"     /\    / ____|__   __|  ____|  __ \     /\    "${CL_CYN}
	@echo -e ${CL_CYN}"    /  \  | |___    | |  | |__  | |__| |   /  \   "${CL_CYN}
	@echo -e ${CL_CYN}"   / /\ \  \___ \   | |  |  __| |  _  /   / /\ \"${CL_CYN}
	@echo -e ${CL_CYN}"  / ____ \ ____| |  | |  | |____| | \ \  / ____ \ "${CL_CYN}
	@echo -e ${CL_CYN}" /_/    \_\_____/   |_|  |______|_|  \_\/_/    \_\"${CL_CYN}
	@echo -e ${CL_CYN}""${CL_CYN}
